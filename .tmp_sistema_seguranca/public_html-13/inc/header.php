...
$navAdmin = [
  ["href"=>"/admin/access/painel_admin.php","icon"=>"shield","label"=>"Painel Admin","perm"=>"admin.view"],
  ["href"=>"/admin/access/users.php","icon"=>"user-cog","label"=>"Usuários","perm"=>"admin.users"],
  ["href"=>"/admin/access/roles.php","icon"=>"badge-check","label"=>"Perfis (Roles)","perm"=>"access.roles"],
  ["href"=>"/admin/access/permissions.php","icon"=>"key","label"=>"Permissões","perm"=>"access.permissions"],
  ["href"=>"/admin/access/role_permissions.php","icon"=>"link-2","label"=>"Vínculos Role × Perm","perm"=>"access.role_permissions"],
  ["href"=>"/admin/access/audit.php","icon"=>"file-search","label"=>"Auditoria","perm"=>"access.audit"],
];
